...
public class BuildVars {
    ...
    public static boolean CHECK_UPDATES = false; // MuseGram: disable official Telegram updates
    public static boolean NO_SCOPED_STORAGE = Build.VERSION.SDK_INT <= 29;
    public static String BUILD_VERSION_STRING = BuildConfig.BUILD_VERSION_STRING;

    // MuseGram: API credentials
    ...
    public static String PLAYSTORE_APP_URL = ""; // MuseGram: not on Play Store
    ...
    public static boolean IS_BILLING_UNAVAILABLE = true; // MuseGram: billing disabled for fork

    // works only on official app ids, disable on your forks
    public static boolean SUPPORTS_PASSKEYS = false; // MuseGram: passkeys only work on official app ids
